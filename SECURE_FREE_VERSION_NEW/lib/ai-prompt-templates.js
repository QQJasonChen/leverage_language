...
class AIPromptTemplates {
   ...
   **🎭 場景重現**: 下次當你...時，自然地說出「[荷蘭語應用句]」`
        ...
        sentence: {
          ...
          structure: `📐 **句子結構詳解**: [詳細解釋句子組成，如：Dit(指示詞) + zijn(動詞) + werkwoorden(主語) + zoals(連接詞) + 列舉...]`,
          detailedGrammar: `🔍 **語法深度分析**: 
   **📝 逐詞分析**: [每個詞的詞性、功能、在句中的作用]
   **🏗️ 句型結構**: 這是[句型名稱]，結構為[主語+動詞+賓語+...]
   **⚡ 關鍵語法點**: [解釋重要語法規則，如動詞變化、詞序規律等]`,
          pronunciation: `🗣️ **發音重點**: 注意這些地方的語調...`,
