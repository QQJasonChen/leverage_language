...
const languageMessages = {
  'en': {
    'extensionName': 'Language Learning Extension',
    'header_title': 'Language Learning Extension',
    'welcome_title': '🎯 Language Learning Extension',
    ...
    'new_tab': '🔗 New Tab',
    'search_results_title': '🎯 AI Language Analysis',
    ...
    'create_first_flashcard': 'Create your first flashcard to start learning!',
  ...
  'zh_TW': {
    ...
    // Flashcards
    'flashcards_view': '🃏 記憶卡',
    'create_flashcard': '建立記憶卡',
    'start_study': '開始學習',
    'study_mode': '學習模式:',
    'word_to_translation': '單字 → 翻譯',
    'translation_to_word': '翻譯 → 單字',
    'audio_to_meaning': '發音 → 含義',
    'mixed_mode': '混合模式',
    'difficulty': '難度篩選:',
    ...
    'exit_study': '退出學習',
    'next_card': '下一張卡片',
    'no_flashcards': '還沒有記憶卡',
    'create_first_flashcard': '建立您的第一張記憶卡開始學習！',
    'create_first_card': '建立第一張卡片',
    // Additional UI elements
