      ...
      <div class="practice-interface">
        ...
        <div class="practice-section">
          ...
          <div class="practice-buttons">
            <button id="submitAnswer" class="primary-btn">🤖 AI評估</button>
            <button id="getHint" class="secondary-btn">💡 提示</button>
            <button id="tryAnother" class="secondary-btn">🔄 換句子</button>
          </div>
        </div>
