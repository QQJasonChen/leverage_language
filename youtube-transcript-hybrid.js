...
(function() {
  ...
  function removeAdvancedRepetitions(text) {
    ...
    // Remove cascading repetitions like "have smaller have smaller"
    for (let len = 2; len <= 5; len++) {
      for (let i = 0; i <= words.length - len * 2; i++) {
        ...
        if (pattern1.toLowerCase() === pattern2.toLowerCase()) {
          words.splice(i + len, len); // Remove the duplicate
          console.log('🗑️ Removed advanced repetition:', pattern1);
          break;
        }
      }
    }
